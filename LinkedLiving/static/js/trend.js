                ...
                function($scope, $http) {
                  ...
                  $scope.showDays = function(timedelta) {
                    if (timedelta == null) {
                      ...
                      var now = new Date();
                      var start = new Date(now.getTime() - timedelta * 24 * 60
                              * 60 * 1000);
                  ...
                  function get_trend_data_by_range(start, end) {
                    ...
                    var request_parameters = {
                      user_id: 123,
                      start_datetime: (start == null ? null : Math.round(start
                              .getTime() / 1000)),
                      end_datetime: (end == null ? null : Math.round(end
                              .getTime() / 1000))
                    };
                  ...
                  $scope.comments = [{
                    ...
                    profile: "sarah.png",
                    date: "4/15/2015",
                    content: "'Recent declines in HR during sleep'"
                  }];
